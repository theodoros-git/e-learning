...
Route::prefix('students')->group(function () {
    ...
    // route pour dashboard eleves
    Route::get('/courses/activities/{id}/files_to_download', [StudentController::class, 'activity_files'])
        ->name('students_activity_files')
        ->middleware('auth');

    Route::get('/courses/activities/files_to_download/{url}', [StudentController::class, 'download'])
        ->name('students_download')
        ->middleware('auth');
