                    ...
                    class="text-center border border-light " enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                                ...
                                <div class="col" style="text-align: left;">
                                    ...
                                    <label class="form-label" for="description">Description de la video</label>

                                    <div style="margin-bottom: 10px;"></div>

                                    <textarea name="description" id="description" value="{{ old('description') }}" style="" rows="6" cols="30" class="form-control"></textarea>
