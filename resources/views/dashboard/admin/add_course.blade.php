                ...
                <div class="card-body">
                    ...
                    class="text-center border border-light " >
                        ...
                        <div class="row mb-4" style="text-align: left;">
                            ...
                            <label class="form-label" for="classe_course">À quelle classe appartient le cours?</label>

                            <div style="margin-bottom: 10px;"></div>

                            <select class="select @error('classe_course') is-invalid @enderror" id="classe_course" name="classe_course">

                              <option value="">--Veuillez choisir la classe--</option>
