      ...
      <div class="row ">
        ...
        <div class="col-md-2">
          ...
          <ul style="opacity: 0.5;">
            ...
            <li class="pt-2"><a href="" style="border-bottom: #229ddc solid 1px; ">
              Devenir parrain ou marraine</a></li>
        ...
        <div class="col-md-2">
          ...
          <ul style="opacity: 0.5;">
            ...
            <li><a href="" style="border-bottom: #229ddc solid 1px; ">Actualités</a></li>
            <li class="pt-2"><a href="" style="border-bottom: #229ddc solid 1px; ">Projets</a></li>
            <li class="pt-2"><a href="" style="border-bottom: #229ddc solid 1px; ">Jobs et stages</a></li>
      ...
      <hr>
        ...
        <div class="row pt-3">
            <div class="col-lg-6">
                ...
                <a class="text-white text-reset " href="">Learning-App</a>
